 $(document).ready(function() {
  ...
  var arrimg = [
      '/h5/dati_sjsr/css/img/cover1.png',
      '/h5/dati_sjsr/css/img/cover2.png',
      '/h5/dati_sjsr/css/img/cover3.png',
  	  '/h5/dati_sjsr/css/img/cover4.png',
  	  '/h5/dati_sjsr/css/img/cover5.png',
  	  '/h5/dati_sjsr/css/img/cover6.png'
    ];
  var loadNum = 0;
...
$('.c5').click(function(){
  ...
  if(quiz_start) return false;
  quiz_start = true;

  $.ajax({
    type: "get",
    async: false,
    url: "/nsrjc/api/ksdt?uid=" + $("#uid").val() ,
...
var quiz_tijiao = false;
//提交答案
$('#tijiao img').click(function(){
    
    // 防止重复提交
    if(quiz_tijiao) return false;
    quiz_tijiao = true;
    ...
    //   type: "post",
    //   async: false,
    //   url: "/nsrjc/api/tijiao?uid=" + $("#uid").val() + "&score=" + cores ,
    //   success: function(json){
