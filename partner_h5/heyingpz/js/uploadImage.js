	...
	if (file) {
		...
		oReader.onload = function(e) {
			...
			image.onload = function() {
				...
				// alert(navigator.userAgent.toLowerCase().match(/Android/i) || navigator.userAgent.indexOf('Android') > -1 || navigator.userAgent.indexOf('Linux') > -1)
				//修复ios
				if (navigator.userAgent.match(/iphone/i)) {
					// console.log('iphone');
					// alert(expectWidth + ',' + expectHeight+','+Orientation);
					...
					base64 = canvas.toDataURL("image/jpeg", 0.8);
				}else if (navigator.userAgent.toLowerCase().match(/Android/i) || navigator.userAgent.indexOf('Android') > -1 || navigator.userAgent.indexOf('Linux') > -1) {// 修复android
				...
				flag = 1;
				$("#shangchuan").attr('src',"css/images/p5_3b.png");
