...
var fileList = [
    '/h5/hypz2/css/images/p3b_2_0.png',
    '/h5/hypz2/css/images/p3b_2_1.png',
    '/h5/hypz2/css/images/p3b_2_2.png',
    '/h5/hypz2/css/images/p3b_2_3.png'
];
var arrindex = [12,7,1,1,1,2,1];
for (var i = 1; i <= 7; i++) {
    for (var j = 1; j <= arrindex[i]; j++) {
        var str = '/h5/hypz2/css/images/p'+i + '_' + j + '.png';
        fileList.push(str);
    }
}
...
// 设置高度 
$('.pepMan,pepWoman').css({'height':getHeight(0.3467,260,246)+'px'});
$('#p2_10').css({'height':getHeight(0.34,253,93)+'px'});
$('.FdressA,.FdressB,.FdressC,.FdressD').css({'height':getHeight(0.132,120,270)+'px'});
$('.MdressA,.MdressB,.MdressC,.MdressD').css({'height':getHeight(0.132,120,270)+'px'});
$('.s3Left,.s3Right').css({'height':getHeight(0.34,253,93)+'px'});
$(".btn_upload>img").css({'height':getHeight(0.7,118,141)+'px'});
$("#btn_upload").css({'height':getHeight(0.32,238,83)+'px'});
$('.s5Left,.s5Right').css({'height':getHeight(0.34,253,93)+'px'});
$('.finalPic').css({'height':getHeight(0.7,531,639)+'px'});
$('#p6Pic').css({'top':"13%"});
$('.s6Left,.s6Right').css({'height':getHeight(0.393,295,88)+'px'});
var Introtop = getHeight(1,750,840);
$('.intro').css({'top':Introtop+'px','height':'80px'});
$('.ewm').css({'top':getHeight(1,750,798)+'px'});
$('.p7_2,.p7b_2').css({'width':'94%','left':'3%'});
// 设置高度 结束
...
$('.s5Right').click(function(){
  if(flag){
    ...
    // 判断modelid 
    var modelid = '';
    if(space==0 && sex==0 && Mdress==0)         modelid = 'qc_100624_095448_14';
    else if(space==0 && sex==0 && Mdress==1)    modelid = 'qc_100624_095427_13';
    else if(space==0 && sex==0 && Mdress==2)    modelid = 'qc_100624_095342_12';
    else if(space==0 && sex==0 && Mdress==3)    modelid = 'qc_100624_095319_11';
    else if(space==0 && sex==1 && Fderess==0)   modelid = 'qc_100624_095620_18';
    else if(space==0 && sex==1 && Fderess==1)   modelid = 'qc_100624_095556_17';
    else if(space==0 && sex==1 && Fderess==2)   modelid = 'qc_100624_095534_16';
    else if(space==0 && sex==1 && Fderess==3)   modelid = 'qc_100624_095512_15';
    else if(space==1 && sex==0 && Mdress==0)    modelid = 'qc_100624_095102_6';
    else if(space==1 && sex==0 && Mdress==1)    modelid = 'qc_100624_095027_5';
    else if(space==1 && sex==0 && Mdress==2)    modelid = 'qc_100624_094946_4';
    else if(space==1 && sex==0 && Mdress==3)    modelid = 'qc_100624_094902_3';
    else if(space==1 && sex==1 && Fderess==0)   modelid = 'qc_100624_095250_10';
    else if(space==1 && sex==1 && Fderess==1)   modelid = 'qc_100624_095224_9';
    else if(space==1 && sex==1 && Fderess==2)   modelid = 'qc_100624_095157_8';
    else if(space==1 && sex==1 && Fderess==3)   modelid = 'qc_100624_095128_7';
    ...
    $.ajax({
        type: "post",
        async: false,
        url: "/weixin/txzpapi/get_data",
        data: {                  
            model_id: modelid,
            img_data: ImageFile[0]
        },
        success: function(json){
          var obj = eval('(' + json + ')');
          //console.log(obj)
          console.log(obj.ret);
          $("#p6Pic").attr("src", obj.img_url);
          $(".finalPic").attr("src", obj.img_url);
...
$('.s6Right').click(function(){
  slides.hide();
  img0 = new Image;
  img0.src = '/h5/hypz2/css/images/bg.png'; 
  drawCanvas();
  if(space){
...
// flag 归0 上传图片回归
function flagBack(){
  $("#shangchuan").attr('src',"/h5/hypz2/css/images/p5_2.png");
...
function drawCanvas(){
    ...
    img1.src = '/h5/hypz2/css/images/p6_1.png';

    img2.setAttribute("crossOrigin",'anonymous');
    img2.src = src2;
    
    img3.src = space ==0 ? '/h5/hypz2/css/images/p7_2pic.png': '/h5/hypz2/css/images/p7b_2pic.png';
