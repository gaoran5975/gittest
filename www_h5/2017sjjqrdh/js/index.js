		...
		if (document.readyState == "complete") {  //判断文档是否加载完成
			...
			$('#fullpage').fullpage({
				afterLoad: function (anchorLink, index) {  //afterLoad是滚动到某一屏后的回调函数   //index是section的索引，从1开始
					...
					if (index ==1) {
						$(".logo").removeClass("fadeInUp").addClass("zoomIn");
						$(".logo").attr("style","width:60%; top:5%;left:20%;");
						$(".section1_up").removeClass("fadeInDown").addClass("fadeInUp");
						$(".section1_up").attr("style","width:100%; top:0%;left:0;");
						$(".section1_down").removeClass("fadeInUp").addClass("fadeInDown");
						$(".section1_down").attr("style","width:100%; top:0%;left:0;");

					}else{
						$(".logo").removeClass("zoomIn");
						$(".logo").attr("style","top:-10%;width:60%;left:20%")
						$(".section1_up").removeClass("fadeInUp");
						$(".section1_up").attr("style","width:100%; top:-100%;left:0;");
						$(".section1_down").removeClass("fadeInDown");
						$(".section1_down").attr("style","width:100%; top:-100%;left:0;");
					}
					if (index ==5) {
